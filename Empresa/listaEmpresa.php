    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="container mt-5">
            ...
            <div class="container mt-4" style="margin: 10px;">
                <h3 class="mb-5">Empresas cadastradas</h3>
                <div class="wrapper">
                    <div class="content">
                        <button class="btn btn-success mb-2"> <a style="text-decoration: none; color:white; font-weight:bold;" href="cadastroEmpresa.php">Adicionar Empresa</a></button>
                    </div>
                    <section class="aluno">
