...
INSERT INTO `aluno` (`RA`, `Email`, `Senha`, `Nome`, `DataNasc`, `IdTurma`) VALUES
	('123', 'cvantim@gmail.com', '123', 'Caroline', '1999-10-09', 1);
...
-- Copiando dados para a tabela maisensina.post: ~6 rows (aproximadamente)
...
BEGIN
	...
	SET idt = (SELECT IdTurma FROM turma WHERE IdTurma = id);
