    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3" style="width: 280px; background-color:#121212;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="../criarPost.php" class="nav-link text-white">
        ...
        <div class="container mt-5">
            ...
            <div class="container mt-4" style="margin: 10px;">
                <h3 class="mb-5">Alunos cadastrados</h3>
                <div class="wrapper">
                    <div class="content">
                        <button class="btn btn-success mb-2"> <a style="text-decoration: none; color:white; font-weight:bold;" href="cadastroAluno.php">Adicionar Aluno</a></button>
                    </div>
                    <section class="aluno">
