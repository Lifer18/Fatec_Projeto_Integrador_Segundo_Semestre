...
<head>
  ...
  <meta name="description" content="Página de postagens dos professores do mais ensina">
...
<body>
  ...
  <main class="d-flex flex-nowrap">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3" style="width: 280px; background-color:#121212;">
      <a href="listaPostProfessor.php" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
