    ...
    if(!isset($_SESSION["administrativo"]) || $_SESSION["administrativo"] !== true){ // TROCAR AQUI PRA CADA PAGINA
     ...
     if($_SERVER["REQUEST_METHOD"] == "POST"){
         if($_POST['titulo'] != "" && $_POST['corpo'] != "")  { 
            ...
            $postes = new Post();
            $postes->cadastrarPost($_POST['titulo'],$_POST['corpo'],$_POST['anexo'],$_POST['turma'],"A",$_SESSION['id']); // TROCAR O TIPO "A" PRA "P" QUANDO FOR PROFESSOR E "E" QUANDO FOR EMPRESA
...
<body>
  ...
  <main class="d-flex flex-nowrap">
    ...
    <!-- End Nav -->
        ...
        <form action="criarPostAdministrativo.php" method="POST">
