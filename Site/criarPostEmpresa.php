    ...
    if(!isset($_SESSION["empresa"]) || $_SESSION["empresa"] !== true){ // se não existir loggedin no session ou loggedin não estuver valido volta para index.php
     ...
     if($_SERVER["REQUEST_METHOD"] == "POST"){
         if($_POST['titulo'] != "" && $_POST['corpo'] != "")  { 
            ...
            $postes = new Post();
            $postes->cadastrarPost($_POST['titulo'],$_POST['corpo'],$_POST['anexo'],$_POST['turma'],"E",$_SESSION['id']); // TROCAR O TIPO "A" PRA "P" QUANDO FOR PROFESSOR E "E" QUANDO FOR EMPRESA
...
<body>
  ...
  <main class="d-flex flex-nowrap">
    ...
    <!-- End Nav -->
        ...
        <form action="criarPostEmpresa.php" method="POST">
