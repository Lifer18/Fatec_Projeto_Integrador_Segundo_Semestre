...
<body>
    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="container mt-5">
            ...
            <div class="container">
                <button class="btn btn-dark" style="width:250px; margin:5px;"><a style="text-decoration: none; color:white;" href="../Professor/listaProfessor.php">Cadastros de Professores</a></button>
            ...
            <div class="container mt-4" style="margin: 10px;">
                <h3 class="mb-5">Administradores cadastrados</h3>
                <div class="wrapper">
                    <div class="content">
                        <button class="btn btn-success mb-2"> <a style="text-decoration: none; color:white; font-weight:bold;" href="cadastroAdmin.php">Adicionar Administrador</a></button>
                    </div>
                    <section class="aluno">
                        <table class="data-table">
                            ...
                            <tbody>
                                ...
                                $admin = new Admin();
                                $admins = $admin->getAdministrativo();
